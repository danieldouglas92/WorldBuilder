...
#include "world_builder/features/subducting_plate_models/composition/tian2019_water_content_modified.h"
...
namespace WorldBuilder
{
  ...
  namespace Features
  {
    namespace SubductingPlateModels
    {
      ...
      {
        TianWaterContentModified::TianWaterContentModified(WorldBuilder::World *world_)
          :
          min_depth(NaN::DSNAN),
          max_depth(NaN::DSNAN),
          density(NaN::DSNAN)
        ...
        TianWaterContentModified::~TianWaterContentModified()
          = default;

        void
        TianWaterContentModified::declare_entries(Parameters &prm, const std::string & /*unused*/)
        {
          // Document plugin and require entries if needed.
          // Add compositions to the required parameters.
          prm.declare_entry("", Types::Object({"compositions"}),
                            "TianWaterContentModified compositional model. Sets bound water content as a compositional field. The returned "
        ...
        void
        TianWaterContentModified::parse_entries(Parameters &prm)
        {
        ...
        double
        TianWaterContentModified::calculate_water_content(double pressure,
        ...
        double
        TianWaterContentModified::get_composition(const Point<3> &position_in_cartesian_coordinates,
                                          const double depth,
                                          ...
                                          const AdditionalParameters & /*additional_parameters*/) const
        {
	      ...
	      const double fractional_value = partition_coefficient * 0.1;
	      partition_coefficient = partition_coefficient + fractional_value;
        ...
        WB_REGISTER_FEATURE_SUBDUCTING_PLATE_COMPOSITION_MODEL(TianWaterContentModified, tian water content mod)
      } // namespace Composition
    } // namespace SubductingPlateModels
  } // namespace Features
} // namespace WorldBuilder
