...
#include "world_builder/features/oceanic_plate_models/composition/tian2019_water_content_modified.h"
  ...
  namespace Features
  {
    namespace OceanicPlateModels
    {
      namespace Composition
      {
        ...
        void
        TianWaterContentModified::parse_entries(Parameters &prm, const std::vector<Point<2>> &coordinates)
        {
        ...
        WB_REGISTER_FEATURE_OCEANIC_PLATE_COMPOSITION_MODEL(TianWaterContentModified, tian water content mod)
      } // namespace Composition
    } // namespace OceanicPlateModels
  } // namespace Features
} // namespace WorldBuilder
