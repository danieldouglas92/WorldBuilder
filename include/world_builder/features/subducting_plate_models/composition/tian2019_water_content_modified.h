...
#ifndef WORLD_BUILDER_FEATURES_SUBDUCTING_PLATE_MODELS_COMPOSITION_WATER_CONTENT_MODIFIED_H
#define WORLD_BUILDER_FEATURES_SUBDUCTING_PLATE_MODELS_COMPOSITION_WATER_CONTENT_MODIFIED_H
  ...
  namespace Features
  {
    namespace SubductingPlateModels
    {
      namespace Composition
      {
         ...
         */
        class TianWaterContentModified final: public Interface
        {
          public:
            /**
             * constructor
             */
            TianWaterContentModified(WorldBuilder::World *world);

            /**
             * Destructor
             */
            ~TianWaterContentModified() override final;
