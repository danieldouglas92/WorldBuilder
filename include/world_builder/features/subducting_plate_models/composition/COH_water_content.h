...
#ifndef WORLD_BUILDER_FEATURES_SUBDUCTING_PLATE_MODELS_COMPOSITION_COH_WATER_CONTENT_H
#define WORLD_BUILDER_FEATURES_SUBDUCTING_PLATE_MODELS_COMPOSITION_COH_WATER_CONTENT_H
  ...
  namespace Features
  {
    namespace SubductingPlateModels
    {
      namespace Composition
      {
         ...
         */
        class COHWaterContent final: public Interface
        {
          public:
            /**
             * constructor
             */
            COHWaterContent(WorldBuilder::World *world);

            /**
             * Destructor
             */
            ~COHWaterContent() override final;
          ...
          private:
            // COHWaterContent composition submodule parameters
            double min_depth;
            double max_depth;
